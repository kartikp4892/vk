...
if !exists('g:tskelMarkerExtra')   | let g:tskelMarkerExtra   = '???' | endif " KARTIK_FIXME
" KARTIK_FIXME: if !exists('g:tskelMarkerExtra')   | let g:tskelMarkerExtra   = '???\|+++\|!!!\|###' | endif
...
if !exists('g:tskeleton#conceal_cchar')
    ...
    if (has('conceal'))
      let g:tskeleton#conceal_cchar = {'utf-8': '⬚', '_': '#'}
    else
      let g:tskeleton#conceal_cchar = {}
    endif
