...
" KP FIXME: Added line to support Systemverilog after adding ~/.ctags file for support
let s:tlist_def_sv_settings='systemverilog;c:class;t:task;f:function;m:module;p:program;i:interface;e:typedef;d:define;v:variable'
"
