...
//               with coverage.
//----------------------------------------------------------------------------
class prototype_monitor#(type REQ = prototype_transaction) extends base_monitor#(REQ);
  ...
  // Handle of prototype configuration type 
  protected prototype_config m_cfg;
  ...
  //--------------------------------------------------------------------
  `uvm_component_param_utils_begin(prototype_monitor#(REQ))
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    // Get prototype configuartion
    m_cfg = m_cfg.get_cfg(this,"prototype_config");
