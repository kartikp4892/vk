...
from sv.base.lexer.Token import Token, Text
...
class TokenGenerator(object):
  ...
  def skip_line (self):
    ...
    m_token = Token(text, tag, start, end, isnewline, m_wspace)
          ...
          for regex_token in REGEX_TOKENS:
            ...
            if match:
              ...
              if tag:
                ...
                self.m_prev_token = self.m_token 
                self.m_token = Token(text, tag, start, end, isnewline, m_wspace)
                isnewline = False
                m_wspace = None
