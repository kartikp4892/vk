...
" Common SV keywords
 ...
 syn keyword sysVerilogStatement  automatic await before 
 ...
 syn keyword sysVerilogStatement  large liblist kill
 ...
 syn keyword sysVerilogStatement  priority process
 ...
 syn keyword sysVerilogStatement  ref real resume
 ...
 syn keyword sysVerilogStatement  specparam suspend
...
"VMM Synopsis
 ...
 syn keyword sysVerilogVMMtask  allocate copy copy_data compare list byte_pack byte_unpack byte_size

 
 syn keyword sysVerilogVMMfield stop_after_n_scenarios stop_after_n_errors stop_after_n_insts 
 syn keyword sysVerilogVMMfield scenario_kind scenario_set notify log items comment
...
" Various Blocks  
 ...
 syn keyword sysVerilogBlock  generate 
 syn keyword sysVerilogBlock  endgenerate 
 ...
 syn keyword sysVerilogBlockC covergroup cross coverpoint cover bins endgroup
 syn keyword sysVerilogBlockC illegal_bins ignore_bins wildcard option
...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"---------------------------- Added by Tushar valu -----------------------------
syn match sysVerilogObject "\<[a-zA-Z0-9_]\+_obj\>"
...
"------------------Added by ronak------------------------------------
syn match   sysVerilogtask "\<[a-zA-Z0-9_]\+_t\>"
syn match   sysVerilogfunction "\<[a-zA-Z0-9_]\+_f\>"
...
if !exists("did_sysVerilog_syntax_inits")
 ...
 " The default methods for highlighting.  Can be overridden later
  ...
  """"""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
  " ----------------------- Added by Tushar Valu ----------------------------
  hi verilogType               guifg=forestgreen gui=bold
  hi sysVerilogObject          guifg=yellow4 gui=bold
...
"----------------------------Added by Malkesh Adesra--------------------------------
  ...
  "------------------Added by ronak------------------------------------
  hi sysVerilogtask                 guifg=violetred1 gui=bold
  hi sysVerilogfunction             guifg=orange3    gui=bold
"----------------------------Added by Malkesh Adesra--------------------------------
